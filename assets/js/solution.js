...
const supportedSocialNetworks = new Map().set('www.facebook.com', 'fa fa-facebook')
                                        .set('twitter.com', 'fa fa-twitter')
                                        .set('www.instagramm.com', 'fa fa-instagramm');
// key - hostname

const lorem = 'Lorem ipsum dolor sit amet consectetur adipisicing elit. Ipsam numquam facere deleniti optio non voluptatem. Autem voluptatum perspiciatis voluptas non.';
...
function createPlaceCardElement(place) {
  ...
  const a = createUlElement(contacts);
